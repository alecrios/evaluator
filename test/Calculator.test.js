...
describe('Calculator.convert()', () => {
	...
	it('throw error for mismatched parentheses', () => {
		expect(() => calculator.convert(['('])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert(['(', '('])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert([')'])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert([')', ')'])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert(['4', '+', '(', '3'])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert(['4', '+', '(', '3', ')', ')'])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert(['2', '*', '3', '('])).to.throw(Error, 'Mismatched parentheses');
		expect(() => calculator.convert(['(', '4', '-', '1', ')', ')'])).to.throw(Error, 'Mismatched parentheses');
	});
	it('process numbers', () => {
...
describe('Calculator.resolve()', () => {
	...
	it('throw error for missing operands', () => {
		expect(() => calculator.resolve([2, 'EXP'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([41, 'MUL'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([1.7, 'DIV'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([7, 'MOD'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([3, 'ADD'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([13, 'SUB'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([3, 4, 'SUB', 'EXP'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([13, 76, 'EXP', 'MUL'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([0, 215, 'ADD', 'DIV'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([43, 4, 'ADD', 'MOD'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([67, 1, 'MOD', 'ADD'])).to.throw(Error, 'Missing operand');
		expect(() => calculator.resolve([7, 79, 'MUL', 'SUB'])).to.throw(Error, 'Missing operand');
	});
	it('throw error for missing operators', () => {
		expect(() => calculator.resolve([2, 4])).to.throw(Error, 'Missing operator');
		expect(() => calculator.resolve([5, 87, 12])).to.throw(Error, 'Missing operator');
		expect(() => calculator.resolve([1, 2, 2, 'DIV'])).to.throw(Error, 'Missing operator');
		expect(() => calculator.resolve([7, 1, 2, 'EXP'])).to.throw(Error, 'Missing operator');
	});
	it('throw error for division by zero', () => {
		expect(() => calculator.resolve([1, 0, 'DIV'])).to.throw(Error, 'Division by zero');
		expect(() => calculator.resolve([3, 7, 'ADD', 0, 'DIV'])).to.throw(Error, 'Division by zero');
	});
...
describe('Calculator.evaluate()', () => {
	...
	tests.forEach((test) => {
		it(`${test.string} = ${test.result}`, () => {
			expect(calculator.evaluate(test.string)).to.eql(test.result);
		});
	});
});
